export const testimonials = [
  {
    id: 1,
    class: "col-xl-5 align-self-end",
    bgClass: "bg-pale-yellow",
    quote: "“Cum sociis natoque penatibus et magnis dis parturient montes.”",
    name: "Coriss Ambady",
...
export const testimonials2 = [
  {
    ...
    avatarSrc: "/assets/img/avatars/te1.jpg",
    name: "Coriss Ambady",
    role: "Financial Analyst",
  },
  {
    ...
    avatarSrc: "/assets/img/avatars/te2.jpg",
    name: "Cory Zamora",
    role: "Marketing Specialist",
  },
  {
    ...
    avatarSrc: "/assets/img/avatars/te3.jpg",
  ...
  },
  {
    ...
    avatarSrc: "/assets/img/avatars/te4.jpg",
    name: "Coriss Ambady",
    role: "Financial Analyst",
  },
  {
...
export const testimonials3 = [
  {
    id: 1,
    quote:
      "“This is a place of perfection established by divine mandate. The church had her first service on Sunday January 11, 2015 and has been growing from grace to grace since then. We believe that the name – City of David Parish trumpets the purpose of God for the city of Calgary and her inhabitants at this time in God’s grand agenda.”",
    name: "Coriss Ambady",
    role: "Financial Analyst",
  },
  {
...
export const features = [
  {
    id: 1,
    iconSrc: "/assets/img/icons/solid/target.svg",
    value: 1000, // Numeric value,
    adjective: "+",
    description: "Completed Projects",
  },
  {
    id: 2,
    iconSrc: "/assets/img/icons/solid/bar-chart.svg",
    value: 4, // Numeric value,
    adjective: "x",
    description: "Revenue Growth",
  },
  {
    id: 3,
    iconSrc: "/assets/img/icons/solid/employees.svg",
    value: 99.7, // Numeric value,
    adjective: "%",
...
export const testimonials6 = [
  {
    ...
    authorName: "Coriss Ambady",
    authorRole: "Financial Analyst",
  },
  {
    id: 2,
    quote:
      "Fusce dapibus, tellus ac cursus tortor mauris condimentum fermentum massa justo sit amet purus sit amet fermentum.",
    authorName: "Cory Zamora",
    authorRole: "Marketing Specialist",
  },
  {
    id: 3,
    quote:
      "Curabitur blandit tempus porttitor. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor eu rutrum. Nulla vitae libero.",
    authorName: "Nikolas Brooten",
    authorRole: "Sales Manager",
  },
  {
    id: 4,
    quote:
      "Etiam adipiscing tincidunt elit convallis felis suscipit ut. Phasellus rhoncus eu tincidunt auctor nullam rutrum, pharetra augue.",
    authorName: "Coriss Ambady",
    authorRole: "Financial Analyst",
  },
];
